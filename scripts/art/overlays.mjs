...
export const overlays = [
  ...
  // Per-Theme fishing water props (#435). zone drives ingest-overlay quantization; place matches
  // every other prop so the scene-separation band shift keeps them aligned. Interim shared
  // activity-fishing-near stays above until the wiring slice deletes it.
