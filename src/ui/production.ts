 ...
 * Herblore (#118) gets a cauldron. Fishing shows no prop (#452): the shoreline lives in the
 * themed near-layer variant instead. Combat needs no overlay (the Monster is its foreground focus).
 *
