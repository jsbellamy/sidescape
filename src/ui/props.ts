 ...
 * Combat needs no prop (the Monster IS the foreground, per the owner framing); Fishing has no
 * CC0/hand-built prop yet, so it's skipped rather than shipping a placeholder. Herblore adds its
 * own branch here without reworking the scene, same as Crafting did.
 *
